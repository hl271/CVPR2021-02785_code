...
if opt.iv=="image":
    ...
    min_CNN = 256
    n_classes = 12
full_length = lengths[0] # 512
full_channel = channels[0] # 96
classes = range(n_classes)

for length in lengths: # lengths = [512] => length = full_length
    for channel in channels: # channels=[96] => channel = full_channel
